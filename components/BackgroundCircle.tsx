...
const BackgroundCircle = (props: Props) => {
  return (
    ...
    >
        <div className='absolute border border-[#403f3f] rounded-full h-[200px] w-[200px] mt-52 animate-ping'/>
        <div className='rounded-full border border-[#F7AB0A] opacity-20 h-[250px] w-[250px] absolute mt-52 animate-pulse '/>
